...
public class CategoryController {
    ...
    public String getProductCountByCategory() {
        List<Object[]> results = categoryService.getProductCountByCategory();
        StringBuilder response = new StringBuilder("Category Product Counts:\n");

        for (Object[] result : results) {
            Long categoryId = (Long) result[0];
            String categoryName = (String) result[1];
            Long numberPro = ((Number) result[2]).longValue();
            response.append("Category ID: ").append(categoryId)
                    .append(", Category Name: ").append(categoryName)
                    .append(", Number of Products: ").append(numberPro).append("\n");
        }
